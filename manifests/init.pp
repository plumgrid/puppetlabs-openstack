...
class openstack (
  $use_hiera = false,
  $region = 'openstack',
  $network_api = '<Set_API_Network>',
  $networks = undef,
  $subnets = undef,
  $routers = undef,
  $router_interfaces = undef,
  $network_external = undef,
  $network_management = '<Set_Data_Network>',
  $network_data = '<Set_Data_Network>',
  ...
  $controller_address_api = '<Set_Controller_IP_Here>',
  $controller_address_management = '<Set_Controller_IP_Here>',
  $storage_address_api = '<Set_Controller_IP_Here>',
  $storage_address_management = '<Set_Controller_IP_Here>',
  ...
  $rabbitmq_hosts = ['<Set_Controller_IP_Here>:5672'],
  ...
  $glance_api_servers = ['<Set_Controller_IP_Here>:9292'],
  $images = undef,
  ...
  $ceilometer_address_management = '<Set_Controller_IP_Here>',
